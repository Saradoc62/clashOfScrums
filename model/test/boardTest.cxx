...
BOOST_AUTO_TEST_CASE(checkBoardEffects)
{
	...
	Card* creature1 = new Creature(atCreature1);
	...
	Card* creature2 = new Creature(atCreature2);	
	...
	Card* spell = new Spell(atSpell);

	//Check state
	BOOST_CHECK_EQUAL(creature1->getCost(), 100);
	BOOST_CHECK_EQUAL(dynamic_cast<Creature*>(creature1)->getDev(), 0);
	BOOST_CHECK_EQUAL(dynamic_cast<Creature*>(creature2)->getDev(), 0);
	...
	BOOST_CHECK_EQUAL(dynamic_cast<Creature*>(creature1)->getDev(), 2);
	BOOST_CHECK_EQUAL(dynamic_cast<Creature*>(creature2)->getDev(), 2);
}
